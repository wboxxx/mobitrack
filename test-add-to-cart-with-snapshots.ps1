...
# 3. Wait for Carrefour to be opened
Write-Host "3. OUVRE CARREFOUR et va sur la page d'accueil" -ForegroundColor Yellow
Write-Host "   (Appuie sur Enter quand c'est pret)" -ForegroundColor Gray
Read-Host
Write-Host ""
